...
IMPORTANT: I SHOULD read ALL memory bank files at the start of EVERY task - this is not optional. Priority: current_task.md > context.md. The memory bank files are located in `Docs\memory-bank` folder.