...
В рамках анализа текущей системы категоризации транзакций в Budget Bot были предложены комплексные улучшения без использования AI компонентов. Ниже представлены все разработанные решения по улучшению извлечения ключевых слов, их нормализации, созданию словаря ключевых слов и улучшению алгоритмов категоризации.
